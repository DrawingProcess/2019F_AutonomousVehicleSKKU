...
float iwanttogothere = 180; // 가고싶은 코너로 가도록 도와주는 
...
//        else if( f_left >= iwanttogothere || f_right >= iwanttogothere)
//        {
//            compute_speed = 0.7;
//            compute_steering = 0;
//            if( f_left >= iwanttogothere )
//            {
//                compute_steering = -1;
//            }
//            else if( f_right >= iwanttogothere )
//            {
//                compute_steering = 1;
//            }
//        }
        else
        {
            ...
            if(left <= side_start && right <= side_start) // 좌우 모두 감지되면
            {
                ...
                compute_steering = diff * steering_gain * 0.7;
            }
