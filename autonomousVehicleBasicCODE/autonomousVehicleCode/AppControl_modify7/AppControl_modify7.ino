...
int angle_limit = 75; // 서보 모터 회전 제한 각 (단위: 도)
...
int punch_time = 60; // 정지 마찰력 극복 시간 (단위 msec)
...
int max_ai_pwm = 210; // 자율주행 모터 최대 출력 (0 ~ 255)
int min_ai_pwm = 80; // 자율주행 모터 최소 출력 (0 ~ 255)
int center_detect = 150; // 전방 감지 거리 (단위: mm)
int center_start = 100; // 전방 출발 거리 (단위: mm)
//int center_stop = 65; // 전방 멈춤 거리 (단위: mm)
int center_stop = 65; // 전방 멈춤 거리 (단위: mm)
int diagonal_detect = 85; // 대각 감지 거리 (단위: mm)
int diagonal_start = 97; // 대각 출발 거리 (단위: mm)
int diagonal_stop = 70; // 대각 멈춤 거리 (단위: mm)
